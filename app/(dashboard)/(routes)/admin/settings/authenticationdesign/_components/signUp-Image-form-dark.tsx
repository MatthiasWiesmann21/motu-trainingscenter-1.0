  ...
  return (
    ...
    <CardHeader>
      <CardTitle className="flex items-center text-xl justify-between">
        <span>{currentLanguage.customize_darkSignUpImageForm_title}</span>
        <Button
          onClick={toggleEdit}
          variant="ghost"
          size="sm"
    ...
    {isEditing && (
      <CardFooter className="flex justify-between">
        ...
        <Button
          onClick={() => onSubmit({ darkSignUpImageUrl: initialData.darkSignUpImageUrl || "" })}
          disabled={!initialData.darkSignUpImageUrl}
        >
