      ...
      >
        ...
        <Tooltip>
          <TooltipTrigger>
            <p
              className={cn(
                "line-clamp-1 whitespace-normal max-w-[130px] text-sm text-start font-semibold text-zinc-500 transition group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300",
