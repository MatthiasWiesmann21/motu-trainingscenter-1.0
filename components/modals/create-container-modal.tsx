...
export const CreateContainerModal = () => {
  ...
  const isModalOpen = isOpen && type === "createContainer";
      ...
      <AlertDialogContent className="overflow-hidden p-0">
        <AlertDialogHeader className="px-6 pt-8">
          <AlertDialogTitle className="text-center text-2xl font-bold">
            {currentLanguage.createContainer_title}
          </AlertDialogTitle>
          <AlertDialogDescription className="text-center">
            {currentLanguage.createContainer_description}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel>
                        {currentLanguage.createContainer_form_label}
                      </FormLabel>
                      <FormControl>
                        <Input
                          disabled={isSubmitting}
                          placeholder={
                            currentLanguage.createContainer_form_placeholder
                          }
                          {...field}
                        />
                      </FormControl>
                      <FormDescription className="dark:text-[#ffffff]">
                        {currentLanguage.createContainer_form_description}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
